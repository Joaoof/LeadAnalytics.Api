...
public class DailyRelatoryService(AppDbContext db)
{
    ...
    public async Task GenerateDailyRelatory(int tenantId, DateTime date)
    {
        ...
        var assignment = await db.LeadAssignments.
            ...
            .Where(a => a.Lead.TenantId == tenantId && a.AssignedAt >= inicioDia && a.AssignedAt <= fimDia)
            .ToListAsync();

        var relatorio = assignment
